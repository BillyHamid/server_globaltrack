...
export async function refreshAlerts(): Promise<number> {
  ...
  refreshInFlight = (async () => {
    ...
    // Index pour lookup O(1) et éviter findFirst répétitifs
