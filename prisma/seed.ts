...
async function main() {
  ...
  // ─── Users ───────────────────────────────────────────────────────────────
  const password = await bcrypt.hash('globaltrack2024', 10)
  ...
  console.log('  sana.djibrill@globaltrack.cd  | globaltrack2024 (admin — Sana DJibrill)')
  console.log('  sana.mohamadi@globaltrack.cd  | globaltrack2024 (vendeur — Sana Mohamadi)')
  console.log('  bernadette@globaltrack.cd     | globaltrack2024 (vendeur — Bernadette)')
}
